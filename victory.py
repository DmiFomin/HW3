...
# Хотел использовать num2word, но получается четырнадцать марта 1879
# Так что добавил строковую дату в словарь
def date_to_string(datestr):
    ...
    return num2words(list_date[0], lang='ru') + ' ' + month + ' ' + list_date[2]
